...
export const PngToGif = () => {
  ...
  const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (files && files.length > 0) {
      ...
      pngFiles.forEach(file => convertToGif(file));
  ...
  const downloadImage = (converted: string, name: string) => {
    ...
    link.href = converted;
    link.download = name.replace(/\.png$/i, ".gif");
      ...
      <div className="max-w-4xl mx-auto">
        <Card className="shadow-md">
          <CardHeader className="bg-primary/5">
            ...
            <CardDescription>Convert your PNG images to GIF format</CardDescription>
          </CardHeader>
          ...
          <CardContent className="pt-6 pb-4 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Tip: All PNG files will be converted to GIF format.
            </p>
          </CardContent>
        </Card>
        ...
        <GuidanceSection title="How to Use the PNG to GIF Converter">
          <div className="space-y-4">
            <p>Upload one or more .png images and they will be automatically converted to .gif format. You can preview and download the converted files instantly.</p>
