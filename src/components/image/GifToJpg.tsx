...
export const GifToJpg = () => {
  ...
  const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (files && files.length > 0) {
      ...
      gifFiles.forEach(file => convertToJpg(file));
  ...
  const downloadImage = (converted: string, name: string) => {
    ...
    link.href = converted;
    link.download = name.replace(/\.gif$/i, ".jpg");
      ...
      <div className="max-w-4xl mx-auto">
        <Card className="shadow-md">
          <CardHeader className="bg-primary/5">
            ...
            <CardDescription>Convert your GIF images to JPG format</CardDescription>
          </CardHeader>
          ...
          <CardContent className="pt-6 pb-4 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Tip: All GIF files will be converted to JPG format.
            </p>
          </CardContent>
        </Card>
        ...
        <GuidanceSection title="How to Use the GIF to JPG Converter">
          <div className="space-y-4">
            <p>Upload one or more .gif images and they will be automatically converted to .jpg format. You can preview and download the converted files instantly.</p>
