...
const temperatureConversions = [
  ...
  { label: "Fahrenheit to Rankine", path: "/convertor/temperature?from=f&to=r" },
  ...
  { label: "Celsius to Rankine", path: "/convertor/temperature?from=c&to=r" },
  ...
  { label: "Kelvin to Rankine", path: "/convertor/temperature?from=k&to=r" },
  { label: "Rankine to Fahrenheit", path: "/convertor/temperature?from=r&to=f" },
  { label: "Rankine to Celsius", path: "/convertor/temperature?from=r&to=c" },
  { label: "Rankine to Kelvin", path: "/convertor/temperature?from=r&to=k" },
