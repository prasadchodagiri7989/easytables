    ...
    <div className="container mx-auto p-6">
      <div className="mb-4">
        <nav className="text-sm text-gray-500">
          Home › Tools › <span className="text-black">ASCII Table</span>
        </nav>
      </div>

      <h1 className="text-3xl font-bold mb-6">ASCII Table (American Standard Code for Information Interchange)</h1>
      ...
      <div className="bg-white rounded-lg shadow p-6 space-y-6">
        ...
        <div>
          <h2 className="text-2xl font-semibold mb-2">Printable ASCII Characters</h2>
        ...
        <div>
          <h2 className="text-2xl font-semibold mb-2">Control Characters (0–31)</h2>
