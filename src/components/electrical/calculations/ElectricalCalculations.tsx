...
const electricalCalculations = [
  ...
  { label: "VA to Amps", path: "/electrical-calculations/va-to-amps" },
  { label: "VA to Watts", path: "/electrical-calculations/va-to-watts" },
  { label: "VA to kVA", path: "/electrical-calculations/va-to-kva" },
  { label: "VA to kW", path: "/electrical-calculations/va-to-kw" },
