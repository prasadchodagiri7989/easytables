...
export const GPACalculator = () => {
  const [courses, setCourses] = useState<{ grade: string; credits: number }[]>([{ grade: "", credits: 3 }]);
    ...
    <>
      <Breadcrumb className="mb-4">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>GPA Calculator</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      ...
      <div className="calculator-container bg-white/40 dark:bg-transparent">
        ...
        <GuidanceSection title="How to Use the GPA Calculator">
          <p>This calculator helps you calculate your GPA based on the grades and credit hours of your courses.</p>
