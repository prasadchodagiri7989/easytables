    ...
    <>
      ...
      <div className="dst-start-guide-container bg-white/40 dark:bg-transparent">
        ...
        <Card className="p-6 glass-card">
          ...
          <h4 className="text-md font-semibold mt-6 mb-2">Australia DST Start & End Dates</h4>
          <pre className="my-4">
{`Year         Start (forward)     End (back)
...
2019-2020    October 6, 2019     April 5, 2020`}
          ...
          <h4 className="text-md font-semibold mt-6 mb-2">Canada DST Start & End Dates</h4>
          <pre className="my-4">
{`Year    Start (forward)    End (back)
...
2019    March 10            November 3`}
          ...
          <h4 className="text-md font-semibold mt-6 mb-2">United Kingdom DST Start & End Dates</h4>
          <pre className="my-4">
{`Year    Start (forward)    End (back)
...
2019    March 31            October 27`}
          ...
          <h4 className="text-md font-semibold mt-6 mb-2">United States DST Start & End Dates</h4>
          <pre className="my-4">
{`Year    Start (forward)    End (back)
2014    March 9             November 2
2015    March 8             November 1
