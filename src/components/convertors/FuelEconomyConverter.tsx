...
export const FuelEconomyConverter = () => {
  const [category, setCategory] = useState(unitCategories[13].value);
...
<Breadcrumb className="mb-4">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbPage>FuelEconomy Convertor</BreadcrumbPage>
        </BreadcrumbList>
      </Breadcrumb>
    <div className="w-full max-w-4xl mx-auto">
      <Card className="w-full max-w-lg mx-auto">
        <CardHeader>
          <CardTitle className="text-2xl">FuelEconomy Converter</CardTitle>
        </CardHeader>
