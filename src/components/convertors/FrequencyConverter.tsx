...
export const FrequencyConverter = () => {
  const [category, setCategory] = useState(unitCategories[12].value);
...
<Breadcrumb className="mb-4">
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbPage>Frequency Convertor</BreadcrumbPage>
        </BreadcrumbList>
      </Breadcrumb>
    <div className="w-full max-w-4xl mx-auto">
      <Card className="w-full max-w-lg mx-auto">
        <CardHeader>
          <CardTitle className="text-2xl">Frequency Converter</CardTitle>
        </CardHeader>
